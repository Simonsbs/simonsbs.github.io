...
const aboutData = {
  ...
  aboutMe:
    "I am Simon B.Stirling, developer from Hadera, Israel. I have rich experience in web site design and building and customization, also I am good at wordpress.",
};
